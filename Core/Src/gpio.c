...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : POWER_24V_2_Pin POWER_24V_1_Pin POWER_5V_Pin ACC_CS_Pin
                           GYRO_CS_Pin */
  GPIO_InitStruct.Pin = POWER_24V_2_Pin|POWER_24V_1_Pin|POWER_5V_Pin|ACC_CS_Pin
                          |GYRO_CS_Pin;
